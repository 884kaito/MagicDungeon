...
public class eAttackCheck : MonoBehaviour
{
    private string checkTag, checkTag2;
    ...
    private void Start()
    {
        checkTag = GameManager.inst.eAttackTag;
        checkTag2 = GameManager.inst.enemyTag;
    }
    ...
    {
        if (collision.CompareTag(checkTag) || collision.CompareTag(checkTag2))
        {
            isEnter = true;
